...
<link rel="icon" href="{{asset('assets/welcome/assets/favicon.ico')}}">
...
<main class="form-signin w-100 m-auto">
  ...
  <form action="{{ route('validar') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <img class="mb-4" src="{{asset('assets/welcome/assets/img/masivo_logo.png')}}" alt="logo-sectur" width="240" height="63">
    ...
    <p class="mt-5 mb-3 text-muted">&copy; Masivo XML</p>
  </form>
</main>
