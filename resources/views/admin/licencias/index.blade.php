                    ...
                    <tbody>
                        @forelse ($licencias as $licencia)
                            <tr>
                                ...
                                @if ($licencia->estado == 'No pagado')
                                    <td><span class="badge bg-warning text-dark">{{$licencia->estado}}</span></td>
                                @elseif($licencia->estado == 'Pagado')
                                    <td><span class="badge bg-success">{{$licencia->estado}}</span></td>
                                @endif
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{ route('licencias.cita.pdf-download', $licencia) }}">
